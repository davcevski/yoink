...
func printUsage(w *os.File) {
	fmt.Fprint(w, `yoink — a colorful, encrypted macOS clipboard history
...
For a global hotkey or "yoink: my keywords" launcher (Raycast/Alfred), see the
"Global hotkey & launchers" section in the README; it uses search + copy.
