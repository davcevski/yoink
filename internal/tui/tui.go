// Package tui renders yoink's colorful, 8-bit-styled clipboard browser with
// Bubble Tea and Lip Gloss. Clips are decrypted once into memory at startup;
// search filters that in-memory set with no further decryption.
//
