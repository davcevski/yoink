...
// Palette from https://colorhunt.co/palette/6aece126ccc2fff57effb76c.
const (
	...
	colorDim    = lipgloss.Color("#2f6f6b") // muted teal for dim text
	colorInk    = lipgloss.Color("#08221f") // dark "ink" for text on highlights
)

// pixelBorder is a chunky half-block frame for an 8-bit feel.
...
// render code declarative and the palette in one place.
type Theme struct {
...
// NewTheme builds the default 8-bit theme.
func NewTheme() Theme {
	return Theme{
		BannerColors: []lipgloss.Style{
